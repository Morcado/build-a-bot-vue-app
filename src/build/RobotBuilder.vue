...
export default {
  ...
  beforeRouteLeave(to, from, next) {
    if (this.addedToCart) {
      ...
      const response = confirm('You have not added any robot to your cart, are you sure you want to leave?');
      next(response);
    }
  },
  components: {
  ...
  computed: {
    ...
    headBorderStyle() {
      return {
        border: this.selectedRobot.head.onSale ? '3px solid red' : '3px solid gray',
      };
    },
  },
  methods: {
